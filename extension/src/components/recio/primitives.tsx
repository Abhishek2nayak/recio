...
/* ---------------- Logo ---------------- */
// Vyooom brand lockup. The mark + wordmark are full-colour blue PNGs (bundled in
// the extension's public/assets) that read on both light and dark surfaces.
// `wordmark={false}` renders the square mark alone.
